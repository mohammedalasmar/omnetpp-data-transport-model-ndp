...
//            iterationvars += std::string(iterationvars.empty() ? "" : ", ") + "$" + varName + "=" + value;   //MOH commented
            iterationvars += std::string(iterationvars.empty() ? "" : ", ") + value;   // MOH ADDED to get rid of '$' and '='
