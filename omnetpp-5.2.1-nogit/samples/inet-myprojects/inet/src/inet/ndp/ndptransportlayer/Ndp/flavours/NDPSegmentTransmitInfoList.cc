...
#include "../../../ndptransportlayer/Ndp/flavours/NDPSegmentTransmitInfoList.h"
...
void NDPSegmentTransmitInfoList::set(uint32_t beg, uint32_t end, simtime_t sentTime)
{
...
const NDPSegmentTransmitInfoList::Item *NDPSegmentTransmitInfoList::get(uint32_t seq) const
{
...
void NDPSegmentTransmitInfoList::clearTo(uint32_t endseq)
{
