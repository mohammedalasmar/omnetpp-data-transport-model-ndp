...
class INET_API TCPBaseAlgStateVariables : public TCPStateVariables
{
  public:
   ...
   uint32 numFastRetransmissions;    // moh added:  number of fast retransmissions
...
class INET_API TCPBaseAlg : public TCPAlgorithm
{
  protected:
    ...
    // list
//    struct AppGateIndexNumRto{
//        int gateIndex;
//        int numTimeOut;
//    };
//
//    typedef std::list<AppGateIndexNumRto> AppGateIndexNumRtoList;
//    AppGateIndexNumRtoList appGateIndexNumRtoList;

//    std::map<int, int> appGateIndexTimeOutMap;
