...
//#include "/Volumes/LocalDataHD/m/ma/ma777/Desktop/omnetpp-5.2/samples/inet/examples/RQ-Implementation/rqtransportlayer/RaptorQ/raptorq_common/RQSegment.h"
namespace inet {
...
class INET_API IPv4RoutingTable : public cSimpleModule, public IIPv4RoutingTable, protected cListener, public ILifecycle
{
  protected:
    ...
    mutable RoutingCache routingCache;
      //std::multimap<IPv4Address, IPv4Route *> routingCache;
...
//    virtual void getRouterId(IPv4Address& a)  ;
    ...
    //MOH: Added
    virtual IPv4Route *findBestMatchingRouteEcmp(IPv4Datagram *datagram, const IPv4Address& dest)   override;
    ...
    //MOH: Added
    virtual IRoute *findBestMatchingRouteEcmp( IPv4Datagram *datagram, const L3Address& dest)   override { return findBestMatchingRouteEcmp(datagram, dest.toIPv4()); }
