...
class INET_API IPv6RoutingTable : public cSimpleModule, public IRoutingTable, protected cListener, public ILifecycle
{
  ...
  public:
   ...
   // MOH: added
    virtual IRoute *findBestMatchingRouteEcmp(IPv4Datagram *datagram,    const L3Address& dest)    override { return const_cast<IPv6Route *>((const_cast<IPv6RoutingTable *>(this))->doLongestPrefixMatch(dest.toIPv6())); }
