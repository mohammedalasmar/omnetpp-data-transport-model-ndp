...
#include <vector>
#include "inet/networklayer/ipv4/IPv4Datagram.h"  //MOH: added
...
class INET_API IIPv4RoutingTable : public IRoutingTable
{
  public:
    ...
    // MOH: Added
    virtual IPv4Route *findBestMatchingRouteEcmp(IPv4Datagram *datagram,    const IPv4Address& dest) = 0;
    using IRoutingTable::findBestMatchingRouteEcmp;
