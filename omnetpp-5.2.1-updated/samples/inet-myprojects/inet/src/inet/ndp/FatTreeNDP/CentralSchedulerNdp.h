...
protected:
    ...
    void scheduleManyToOneLongFlowsBackgroundTraffice();
    ...
    void scheduleNewManyToOneSingleBlock(std::string dest, std::vector<std::string> senders, unsigned int multiSrcGroupId);
    void  scheduleNewManyToOneMultiBlock(std::string dest, std::vector<std::string> senders, unsigned int multiSrcGroupId);
