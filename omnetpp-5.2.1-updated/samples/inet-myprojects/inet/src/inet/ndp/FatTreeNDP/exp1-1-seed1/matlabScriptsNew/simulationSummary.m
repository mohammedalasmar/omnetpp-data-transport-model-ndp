...
figure,
t0=annotation('textbox', [0.2 0.2 0.8 0.8], 'String', 'Simulation Summary' ,'FitBoxToText','on');
sz = t0.FontSize;
t0.FontSize = 16;
c = t0.Color;
t0.Color = 'red';
...
% flowSizeStr=['shortFlowSize = ' , num2str(flowSize) ,' packets = ' num2str(flowSizeBytes) , flowSizeBytesUnit];
flowSizeStr=['shortFlowSize = '  , num2str(flowSizeBytes) , flowSizeBytesUnit];
